    ...
    <section id="home" class="section home">
        <div class="left  home__data home__container container grid">
            ...
            <p>Cette formation pratique vous offre l’opportunité de
                ...
                d’améliorer vos
                perspectives d’emploi grâce à l’obtention d’un
                certfiact.</p>
                    ...
                    <div class="row g-5 justify-content-center">
                        <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="price-item bg-light rounded text-center">
                                <div class="text-center text-dark border-bottom d-flex flex-column justify-content-center p-4"
                                    ...
                                    <p class="fs-2 fw-bold text-uppercase mb-0" style="color: #000;">Normale</p>

                                    <div class="d-flex justify-content-center">

                                        <p class="mb-0"><span class="display-5" style="color: #202DE6;">110
                                                000 F
                                                Cfa</span></p>
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="price-item bg-light rounded text-center">
                                <div class="text-center text border-bottom d-flex flex-column justify-content-center p-4"
                                    style="width: 100%; height: 160px;">
                                    <p class="fs-2 fw-bold text-uppercase mb-0" style="color: #000;">Accélérée</p>

                                    <div class="d-flex justify-content-center">

                                        <p class="mb-0"><span class="display-5">130
                                                000 F
                                                Cfa</span></p>
                                    </div>
                                    <div class="justify-content-center">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="price-item bg-light rounded text-center">
                                <div class="text-center text border-bottom d-flex flex-column justify-content-center p-4"
                                    style="width: 100%; height: 160px;">
                                    <p class="fs-2 fw-bold text-uppercase mb-0" style="color: #000;">Premium
                                        ou VIP</p>
            ...
            <div class="feature-inner row">
                <div class="col-lg-12">
                    <div class="section-title text-left">
                        ...
                        <p>
                            Spécialisé en formation, nous proposons des programmes de qualité pour développer vos
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="other-feature-item">
                        ...
                        <div>
                            <p>
                                Savoir choisir l'engin de manutention et l'équipement porte-charge adaptés est essentiel
                                pour garantir l'efficacité et la sécurité des opérations. Cela implique de comprendre
                                les spécificités de chaque engin en fonction du type de charge, de l'environnement de
                                travail et des exigences logistiques, afin d'assurer une manutention optimale et sans
                                risque.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mt--160">
                    <div class="other-feature-item">
                        ...
                        <div>
                            <p>
                                Effectuer les contrôles à la prise de poste est une étape cruciale pour garantir la
                                sécurité et la conformité des équipements avant le début des opérations. Cela consiste à
                                vérifier le bon état de fonctionnement, le respect des normes de sécurité et le bon
                                réglage des outils et machines, assurant ainsi un environnement de travail sûr et
                                efficace.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mt--260">
                    <div class="other-feature-item">
                        ...
                        <div>
                            <p>
                                Le classement des équipements porte-charge consiste à organiser et identifier les
                                différents outils de manutention en fonction de leurs caractéristiques et de leurs
                                usages. Cette démarche permet d'optimiser l'espace de stockage, de faciliter l'accès aux
                                équipements nécessaires et d'assurer une gestion efficace et sécurisée des ressources de
                                manutention.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="other-feature-item">
                        ...
                        <div>
                            <p>
                                Utiliser les guides des constructeurs et les manuels d’utilisation est essentiel pour
                                garantir un fonctionnement correct et sécuritaire des équipements. Ces documents
                                fournissent des instructions détaillées sur l'installation, l'utilisation et l'entretien
                                des machines, permettant de maximiser leur performance tout en minimisant les risques
                ...
                <div class="col-lg-4 col-md-6 mt--160">
                    <div class="other-feature-item">
                        ...
                        <div>
                            <p>
                                L'hygiène et la sécurité sont fondamentales pour créer un environnement de travail sûr
                                et sain. Elles impliquent la mise en place de pratiques et de protocoles visant à
                                prévenir les risques sanitaires et les accidents, tout en assurant le bien-être des
                                employés. Cela comprend des mesures telles que le nettoyage régulier des installations,
                                la gestion des déchets, la prévention des risques ergonomiques, et le respect des normes
                ...
                <div class="col-lg-4 col-md-6 mt--260">
                    <div class="other-feature-item">
                        ...
                        <div>
                            <p>
                                Le conducteur de chariot élévateur a pour mission d’effectuer des opérations de
                                transport, stockage et déchargement en utilisant un chariot élévateur adapté. Il doit
                                suivre strictement les consignes de sécurité et assurer la maintenance de base du
                                chariot. L’utilisation d’un système d’information facilite la recherche d’informations
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <p class="mb-4">Grâce à notre expertise, à notre service client exceptionnel
                            et à notre engagement indéfectible à fournir des solutions personnalisées, nous sommes
                            devenus
                            le choix privilégié pour ceux qui recherchent une qualité inégalée et une attention
                            particulière
                            ...
                            <div class="col-12">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <span>Un service client exceptionnel et des solutions sur mesure.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
